  ...
  <div class="table-container">
    ...
    if (isset($_REQUEST['id'])) {
      ...
      if (isset($_POST['guardar'])) {
        ...
        $sql = "UPDATE frutas SET nombre='$nombre', tipo='$tipo', sabor='$sabor' WHERE id=$recuperada";
    ...
    <?php
      ...
      $sql = "SELECT id, nombre, tipo, sabor FROM frutas WHERE id=$recuperada";
